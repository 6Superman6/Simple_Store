...
public class ServerResponse<T> implements Serializable {
    ...
    public static <T> ServerResponse<T> setMessage2(int status, String msg) {
        return new ServerResponse<>(status, msg);
    }
    public static <T> ServerResponse<T> setMessage3(int status, String msg,T data) {
        return new ServerResponse<>(status, msg,data);
    }
    public static <T> ServerResponse<T> setMessage4(int status, String msg,List<T> list) {
        return new ServerResponse<>(status, msg,list);
    }
