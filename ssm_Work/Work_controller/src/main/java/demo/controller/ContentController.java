...
//        System.out.println(icon+"publicSubmit : "+content);
...
//        System.out.println(id+" "+serverResponse1.getStatus()+" "+serverResponse1.getMsg());
...
//    }
    ...
    public String findAll2(HttpServletRequest request,Model model)
    {
        List<Content> productList = contentService.findAllwBuy();
        request.getSession().setAttribute("productList",productList);
    ...
    public String findAll3(HttpServletRequest request,Model model)
    {
        List<Content> productList = contentService.findAllyBuy();
        request.getSession().setAttribute("productList",productList);
    ...
    public ServerResponse get(@RequestParam("id") int id)
    {
        int content = contentService.getCountById(id);
        return ServerResponse.createBySuccess("信息: "+content);
    }

    @RequestMapping(path = "/buy")
    public ServerResponse buy(@RequestParam("id") int id)
    {
        System.out.println(id);
        return ServerResponse.createBySuccess("成功",true);
    }
